...
import edu.tjpu.calendarExpand.LunarCalendar;
import edu.tjpu.calendarExpand.SpecialCalendar;
...
public class CalendarAdapter extends BaseAdapter {
	...
	private edu.tjpu.calendarExpand.SpecialCalendar sc = null;
	private edu.tjpu.calendarExpand.LunarCalendar lc = null;
	...
	public CalendarAdapter(Context context, Resources rs, int year, int month, int day){
		this();
		this.context = context;
		sc = new edu.tjpu.calendarExpand.SpecialCalendar();
		lc = new edu.tjpu.calendarExpand.LunarCalendar();
		this.res = rs;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		if (convertView == null) {
			convertView = LayoutInflater.from(context).inflate(R.layout.calender_item, null);
		}
		...
		if (currentFlag == position) {
			// 设置当天的背景
			drawable = new ColorDrawable(Color.rgb(23, 126, 214));         //更改日期背景颜色
